...
3. SI la tache implementée est correcte marche bien rempli les attentes regarde le fichier 00 du sprint et si la tache est la derniere du sprint donne moi un message de commit complet pour le sprint pas juste pour les taches implementées ne fais aucune action juste donne moi le message.