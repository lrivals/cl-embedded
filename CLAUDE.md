...
3. SI la tache implementée est correcte marche bien rempli les attentes et quelle correpond à la derniere tache d'un sprint, Propose un message de commit.
