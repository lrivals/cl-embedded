# S17-03 — Mise à jour `configs/unsupervised_config.yaml` pour CWRU
...
| **Priorité** | 🔴 Critique |
| **Durée estimée** | 0.5h |
| **Dépendances** | S17-01 (scénario), S17-02 (loader) |
...
```yaml
# --- Bloc CWRU Anomaly Detection (ajout Sprint 17) ---
DATASETS:
  # ... blocs monitoring et pronostia existants ...
  cwru:
    INPUT_DIM: 9
    N_TASKS: 3
    SPLIT_STRATEGY: "by_severity"   # ou "by_fault_type" selon décision S17-01
