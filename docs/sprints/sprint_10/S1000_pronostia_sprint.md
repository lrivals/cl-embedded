...
|-----|--------|----------|--------|--------|
| exp_044 | EWC | Pronostia no_split | `pronostia_single_task_config.yaml` | ✅ AUC=0.90 F1=0.76 |
| exp_045 | HDC | Pronostia no_split | `pronostia_single_task_config.yaml` | ✅ AUC=0.67 F1=0.28 |
| exp_046 | TinyOL | Pronostia no_split | `pronostia_single_task_config.yaml` | ✅ AUC=0.97 F1=0.67 |
| exp_047 | KMeans | Pronostia no_split | `pronostia_single_task_config.yaml` | ✅ AUC=0.90 F1=0.38 |
| exp_048 | Mahalanobis | Pronostia no_split | `pronostia_single_task_config.yaml` | ✅ AUC=0.89 F1=0.28 |
| exp_049 | DBSCAN | Pronostia no_split | `pronostia_single_task_config.yaml` | ✅ AUC=0.84 F1=0.26 ⚠️RAM |
| exp_050 | EWC | Pronostia by_condition (3 tâches) | `pronostia_config.yaml` | ✅ AA=0.982 AF=0.000 BWT=+0.005 RAM=1.1Ko |
| exp_051 | HDC | Pronostia by_condition (3 tâches) | `pronostia_config.yaml` | ✅ AA=0.805 AF=0.045 BWT=-0.045 RAM=14.2Ko |
| exp_052 | TinyOL | Pronostia by_condition (3 tâches) | `pronostia_config.yaml` | ✅ AA=0.930 AF=0.020 BWT=-0.020 RAM=3.6Ko |
| exp_053 | KMeans | Pronostia by_condition (3 tâches) | `pronostia_config.yaml` | ✅ AA=0.890 AF=0.031 BWT=-0.031 RAM=5.4Ko |
| exp_054 | Mahalanobis | Pronostia by_condition (3 tâches) | `pronostia_config.yaml` | ✅ AA=0.793 AF=0.169 BWT=-0.169 RAM=1.7Ko |
| exp_055 | DBSCAN | Pronostia by_condition (3 tâches) | `pronostia_config.yaml` | ✅ AA=0.901 AF=0.000 BWT=+0.005 RAM=118.2Ko ⚠️RAM |

---

## Critères d'acceptation

- [x] S10-01 : `PronostiaDataset` et `PronostiaConditionStream` importables depuis `src.data.pronostia_dataset`
- [x] S10-02 : `pronostia_config.yaml` et `pronostia_single_task_config.yaml` validés (chargement sans erreur)
- [x] S10-03 : Notebook dédié `01C_data_exploration_pronostia.ipynb` exécuté sans erreur, 14 figures dans `notebooks/figures/eda/pronostia/`
- [x] S10-04 : exp_044–049 exécutées, métriques présentes dans chaque dossier `experiments/exp_04X/results/`
- [x] S10-05 : exp_050–055 exécutées, métriques CL (aa/af/bwt) présentes — DBSCAN hors budget RAM (118 Ko ⚠️)
- [x] S10-06 : 6 notebooks dans `notebooks/cl_eval/pronostia_by_condition/`, figures centralisées dans `comparison/pronostia/`
- [x] S10-07 : `comparison.ipynb` (7 figures) et `baselines/pronostia_single_task.ipynb` (4 figures) exécutés sans erreur
- [x] S10-08 : `tests/test_pronostia_dataset.py` implémenté (9 tests sur fixtures synthétiques)
- [x] S10-09 : `roadmap_phase1.md` : sprint 10 ✅ TERMINÉ (24 avril 2026), zéro `FIXME(gap1)` non résolu
