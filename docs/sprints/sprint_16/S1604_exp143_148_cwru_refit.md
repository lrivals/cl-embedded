# S16-04 — exp_143–148 : 6 modèles CWRU refit
...
| **Priorité** | 🔴 Critique |
| **Durée estimée** | 2h |
| **Dépendances** | S16-02 (loader), S16-03 (config), S14-01 (EWC one-class) |
...
Exécuter les 6 modèles d'anomaly detection sur CWRU (scénario retenu en S16-01) en stratégie refit. Ces 6 expériences clôturent la numérotation exp_123–148 de la Phase Anomaly Detection.
