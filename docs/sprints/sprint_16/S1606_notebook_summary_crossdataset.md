# S16-06 — Notebook récapitulatif cross-dataset Phase Anomaly Detection
...
| **Priorité** | 🟡 Important |
| **Durée estimée** | 2h |
| **Dépendances** | S14-10 (Monitoring), S15-06 (Pronostia), S16-05 (CWRU) |
...
Produire le notebook de synthèse finale de la Phase Anomaly Detection (Sprints 13–16) : tableau AUROC 6 modèles × 3 datasets, analyse cross-dataset, et recommandations pour le manuscrit et le portage STM32N6.
...
- **Gap 3** (quantification INT8) : non abordé dans cette phase (Phase 2)
